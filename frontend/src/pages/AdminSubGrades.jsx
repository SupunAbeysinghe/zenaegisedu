...
const AdminSubGrades = ({ gradeCategories, streams }) => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">Sub Grade Management</h1>
        <p className="text-gray-600 dark:text-gray-300 mb-6">Manage detailed grade levels and their organization within streams.</p>
      </div>
